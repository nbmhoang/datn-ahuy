                ...
                if (data.message.length > 0) {
                    data.message.forEach((schedule, index) => {
                        ...
                        if (index === data.message.length - 1 && schedule.isDisable === true) {
                            html += `<div>
                            Không có lịch khám nào được lên lịch trong khung thời gian hiện tại. Vui lòng chọn các lịch khám theo lịch trình tiếp theo.
                            </div>`
                        }
                        ...
                        moreInfo = `
                         <div class="d-flex flex-column">
                                    <div>
                                                <span class="d-block mt-2">Choose <i class="fa fa-hand-o-up" aria-hidden="true"></i>  và đặt lịch tư vấn miễn phí</span>
                                    </div>
                                    ...
                                    <span class="d-block pt-2">Giá: 500,000 VND</span>
                                </div>
            ...
            success: function(data) {
                ...
                if (data.message.length > 0) {
                    data.message.forEach((schedule, index) => {
                        ...
                        if (index === data.message.length - 1 && schedule.isDisable === true) {
                            html += `<div>
                            Không có lịch khám nào được lên lịch trong khung thời gian hiện tại. Vui lòng chọn các lịch khám tiếp theo.
                            </div>`
                        }
